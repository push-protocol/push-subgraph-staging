...
export class EPNSCoreV1__channelsResult {
  value0: i32;
  value1: boolean;
  value2: BigInt;
  value3: BigInt;
...
export class EPNSCoreV1__usersResult {
  value0: boolean;
  value1: boolean;
  value2: boolean;
  value3: BigInt;
...
export class EPNSCoreV1 extends ethereum.SmartContract {
  static bind(address: Address): EPNSCoreV1 {
    return new EPNSCoreV1("EPNSCoreV1", address);
  }
  ...
  channels(param0: Address): EPNSCoreV1__channelsResult {
    let result = super.call(
      "channels",
    ...
    return new EPNSCoreV1__channelsResult(
      result[0].toI32(),
      result[1].toBoolean(),
      result[2].toBigInt(),
      result[3].toBigInt(),
  ...
  try_channels(
    param0: Address
  ): ethereum.CallResult<EPNSCoreV1__channelsResult> {
    let result = super.tryCall(
      "channels",
      "channels(address):(uint8,bool,uint256,uint256,uint256,uint256,uint256,uint256,uint256,uint256)",
      [ethereum.Value.fromAddress(param0)]
    ...
    return ethereum.CallResult.fromValue(
      new EPNSCoreV1__channelsResult(
        value[0].toI32(),
        value[1].toBoolean(),
        value[2].toBigInt(),
        value[3].toBigInt(),
  ...
  users(param0: Address): EPNSCoreV1__usersResult {
    let result = super.call(
      "users",
    ...
    return new EPNSCoreV1__usersResult(
      result[0].toBoolean(),
      result[1].toBoolean(),
      result[2].toBoolean(),
      result[3].toBigInt(),
  ...
  try_users(param0: Address): ethereum.CallResult<EPNSCoreV1__usersResult> {
    let result = super.tryCall(
      "users",
      "users(address):(bool,bool,bool,uint256,uint256,uint256)",
      [ethereum.Value.fromAddress(param0)]
